...
final class FeedAnnotationManagerTests: XCTestCase {
    ...
    func testRemoveAllOnEmpty() {
        manager.removeAllAnnotations() // should not crash
        XCTAssertEqual(manager.annotations.count, 0)
    }
    ...
    func testAnnotationsForArticle() {
        ...
        XCTAssertEqual(result[0].characterOffset, 50)  // sorted by offset
    ...
    func testRecentlyAnnotatedArticles() {
        ...
        XCTAssertEqual(recent[0].count, 1) // A2 is most recent
        XCTAssertEqual(recent[1].count, 2) // A1 has 2 annotations
    }
    ...
    func testExportImportJSON() {
        ...
        let manager2 = FeedAnnotationManager(userDefaults: UserDefaults(suiteName: "FeedAnnotationImport")!)
        ...
        UserDefaults(suiteName: "FeedAnnotationImport")?.removePersistentDomain(forName: "FeedAnnotationImport")
    }
