...
public class PromptStyleTransformerTests
{
    ...
    {
        var result = _transformer.Transform("I can't do it, don't worry.", TransformStyle.Formal);
        Assert.Contains("cannot", result.Transformed);
        Assert.Contains("do not", result.Transformed);
        Assert.Equal(TransformStyle.Formal, result.TargetStyle);
    }

    [Fact]
    public void Transform_Formal_ReplacesCasualWords()
    {
        var result = _transformer.Transform("Hey, can you fix this bug?", TransformStyle.Formal);
    ...
    {
        var result = _transformer.Transform("Please utilize this. Do not forget.", TransformStyle.Casual);
    ...
    {
        var result = _transformer.Transform("Furthermore, this is important. Therefore act now.", TransformStyle.Casual);
    ...
    {
        var result = _transformer.Transform("Please help me write code. Thank you.", TransformStyle.Concise);
    ...
    {
        var result = _transformer.Transform("I think basically you should just do it.", TransformStyle.Concise);
    ...
    {
        var result = _transformer.Transform("Serialize the payload and check latency.", TransformStyle.Simple);
    ...
    {
        var result = _transformer.Transform("Sort a list", TransformStyle.Verbose);
    ...
    {
        var result = _transformer.Transform("You are a coding assistant.", TransformStyle.Verbose);
    ...
    {
        var result = _transformer.Transform("Read the file. Parse the data. Output results.", TransformStyle.Instructional);
    ...
    {
        var result = _transformer.Transform("Do the thing.", TransformStyle.Instructional);
    ...
    {
        var result = _transformer.Transform("Write a sorting algorithm.", TransformStyle.Socratic);
    ...
    {
        var result = _transformer.Transform("What is recursion?", TransformStyle.Socratic);
    ...
    public void TransformChain_AppliesMultipleStyles()
    {
        var result = _transformer.TransformChain(
            ...
            TransformStyle.Concise, TransformStyle.Formal
        );
        Assert.DoesNotContain("Thank you", result.Transformed);
        Assert.Equal(TransformStyle.Formal, result.TargetStyle);
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _transformer.Transform(null!, TransformStyle.Formal));
    }

    [Fact]
    public void Transform_EmptyString_ReturnsEmpty()
    {
        var result = _transformer.Transform("", TransformStyle.Concise);
    ...
    {
        var result = _transformer.Transform("Hello world, this is a test.", TransformStyle.Formal);
    ...
    public void Transform_OriginalIsPreserved()
    {
        ...
        var result = _transformer.Transform(input, TransformStyle.Formal);
    ...
    {
        Assert.Throws<ArgumentNullException>(() => _transformer.TransformChain(null!, TransformStyle.Formal));
    }
